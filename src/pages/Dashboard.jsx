...
function getPersonalGreeting() {
  ...
  if (h < 6) return 'Góða nótt, Addi 🌙'
  if (h < 12) return 'Góðan daginn, Addi ☀️'
  if (h < 18) return 'Góðan dag, Addi 👋'
  return 'Gott kvöld, Addi 🌆'
}
  ...
  return (
    <div className="flex flex-col gap-4 pb-4 animate-slide-up">
      ...
      <div className="px-1 pt-2">
        <div className="text-2xl font-semibold">{getPersonalGreeting()}</div>
