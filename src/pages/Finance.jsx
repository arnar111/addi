...
const INCOME_SOURCES = [
  { id: 'lendo', label: 'Lendó', icon: '🏠', color: '#8b5cf6' },
  { id: 'salary', label: 'Laun', icon: '💼', color: '#00d4aa' },
  { id: 'freelance', label: 'Frítími', icon: '💻', color: '#3b82f6' },
...
export default function Finance() {
  const {
    ...
    budget, setBudget, monthlyTotal, monthlyIncomeTotal, netBalance,
    ...
    <div className="flex flex-col gap-4 pb-4 animate-slide-up">
      <div className="flex items-center justify-between px-1 pt-2">
        ...
        <div className="flex gap-2">
          <button onClick={() => { setShowIncomeForm(!showIncomeForm); setShowForm(false) }} className="btn btn-ghost text-sm">
            <ArrowDownLeft size={15} style={{ color: 'var(--success)' }} /> Tekjur
          </button>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="card-sm text-center">
          <div className="text-xs mb-1" style={{ color: 'var(--success)' }}>Tekjur</div>
        ...
        <div className="card-sm text-center">
          ...
          <div className="font-semibold text-sm">{formatShortISK(total)}</div>
        </div>
        <div className="card-sm text-center">
          <div className="text-xs mb-1" style={{ color: net >= 0 ? 'var(--accent)' : 'var(--danger)' }}>Nettó</div>
          <div className="font-semibold text-sm" style={{ color: net >= 0 ? 'var(--accent)' : 'var(--danger)' }}>
