...
export default function Settings() {
  ...
  const clearData = () => {
    ...
    const keys = ['addi_tasks', 'addi_habits', 'addi_expenses', 'addi_notes', 'addi_budget', 'addi_income', 'addi_income_goal', 'addi_survivor_team', 'addi_survivor_scores', 'addi_survivor_eliminated']
