...
export default function Settings() {
  ...
  const clearData = () => {
    ...
    const keys = [
      'addi_tasks', 'addi_habits', 'addi_expenses', 'addi_income',
      'addi_notes', 'addi_budget', 'addi_pl_table', 'addi_pl_table_at',
    ]
    ...
    <div className="flex flex-col gap-4 pb-4 animate-slide-up">
      ...
      <div className="card flex flex-col gap-2" style={{ border: '1px solid rgba(0,212,170,0.2)' }}>
        ...
        <p className="text-xs leading-relaxed" style={{ color: 'var(--muted)' }}>
          <strong style={{ color: 'var(--text)' }}>iPhone:</strong> Veldu "Deila" →
          "Bæta við heimaskjá" til að nota Addi eins og native app.{' '}
          <strong style={{ color: 'var(--text)' }}>Android:</strong> Veldu "Bæta við heimaskjá" úr Chrome valmynd.
        </p>
      </div>
      ...
      <div className="card flex flex-col gap-3" style={{ border: '1px solid rgba(239,68,68,0.2)' }}>
        ...
        <p className="text-xs" style={{ color: 'var(--muted)' }}>
          Þetta mun eyða öllum gögnum í appinu — verkefnum, fjármálum, tekjum, minnisblöðum og venjum.
