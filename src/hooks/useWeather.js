...
const WEATHER_CODES = {
  ...
  1: { label: 'Aðallega skýlaust', icon: '🌤️' },
  2: { label: 'Hlutaskýjað', icon: '⛅' },
  3: { label: 'Þungskýjað', icon: '☁️' },
  45: { label: 'Þoka', icon: '🌫️' },
  48: { label: 'Frystiþoka', icon: '🌫️' },
  51: { label: 'Smáúrkomi', icon: '🌦️' },
  53: { label: 'Úrkomi', icon: '🌦️' },
  55: { label: 'Þung úrkomi', icon: '🌧️' },
