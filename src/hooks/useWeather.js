...
const WEATHER_CODES = {
  ...
  48: { label: 'Frerin þoka', icon: '🌫️' },
  51: { label: 'Létt úðaregn', icon: '🌦️' },
  53: { label: 'Úðaregn', icon: '🌦️' },
  55: { label: 'Mikið úðaregn', icon: '🌧️' },
  61: { label: 'Létt rigning', icon: '🌧️' },
  63: { label: 'Rigning', icon: '🌧️' },
  65: { label: 'Mikil rigning', icon: '🌧️' },
  71: { label: 'Létt snjókoma', icon: '❄️' },
  73: { label: 'Snjókoma', icon: '❄️' },
  75: { label: 'Mikil snjókoma', icon: '❄️' },
  77: { label: 'Snjóbyrð', icon: '🌨️' },
  80: { label: 'Skúrir', icon: '🌦️' },
  81: { label: 'Skúrir', icon: '🌦️' },
  82: { label: 'Miklar skúrir', icon: '⛈️' },
  85: { label: 'Snjóskúrir', icon: '🌨️' },
  86: { label: 'Miklar snjóskúrir', icon: '🌨️' },
  95: { label: 'Þrumuveður', icon: '⛈️' },
  96: { label: 'Þrumuveður', icon: '⛈️' },
  99: { label: 'Þrumuveður', icon: '⛈️' },
}
