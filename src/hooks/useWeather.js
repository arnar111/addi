...
const WEATHER_CODES = {
  ...
  2: { label: 'Nokkrar skýjar', icon: '⛅' },
  3: { label: 'Skýjað', icon: '☁️' },
  45: { label: 'Þoka', icon: '🌫️' },
  48: { label: 'Ísingþoka', icon: '🌫️' },
  51: { label: 'Hárél', icon: '🌦️' },
  53: { label: 'Hárél', icon: '🌦️' },
  55: { label: 'Þungt hárél', icon: '🌧️' },
