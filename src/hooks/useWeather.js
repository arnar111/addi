...
const WEATHER_CODES = {
  0: { label: 'Bjart', icon: '☀️' },
  1: { label: 'Lítið skýjað', icon: '🌤️' },
  2: { label: 'Hlutaskýjað', icon: '⛅' },
  3: { label: 'Þungaskýjað', icon: '☁️' },
  45: { label: 'Þoka', icon: '🌫️' },
  48: { label: 'Frostaþoka', icon: '🌫️' },
  51: { label: 'Súld', icon: '🌦️' },
  53: { label: 'Súld', icon: '🌦️' },
  55: { label: 'Þung súld', icon: '🌧️' },
  ...
  95: { label: 'Þrumaél', icon: '⛈️' },
  96: { label: 'Þrumaél', icon: '⛈️' },
  99: { label: 'Þrumaél', icon: '⛈️' },
}
