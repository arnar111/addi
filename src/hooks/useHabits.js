...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    ...
    { id: '2', name: 'Huel / Matur', icon: '🥤', color: '#22c55e', completions: [] },
    { id: '3', name: 'Hlusta á bók', icon: '🎧', color: '#8b5cf6', completions: [] },
    { id: '4', name: 'Drekka vatn', icon: '💧', color: '#3b82f6', completions: [] },
    { id: '5', name: 'Senda umsókn', icon: '💼', color: '#f97316', completions: [] },
  ])
