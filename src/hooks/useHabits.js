...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    { id: '1', name: 'Líkamsrækt', icon: '🏋️', color: '#f97316', completions: [] },
    { id: '2', name: 'Lesa', icon: '📖', color: '#8b5cf6', completions: [] },
    { id: '3', name: 'Drekka vatn', icon: '💧', color: '#00d4aa', completions: [] },
    { id: '4', name: 'Kalt sturta', icon: '🚿', color: '#3b82f6', completions: [] },
    { id: '5', name: 'Fótbolti/Ganga', icon: '⚽', color: '#22c55e', completions: [] },
  ])
