...
const DEFAULT_HABITS = [
  { id: '1', name: 'Duolingo', icon: '🦜', color: '#58cc02', completions: [] },
  { id: '2', name: 'Hreyfingarækt', icon: '🏋️', color: '#00d4aa', completions: [] },
  { id: '3', name: 'Huel / Prótín', icon: '🥤', color: '#8b5cf6', completions: [] },
  { id: '4', name: 'Lesa / Hlusta', icon: '📚', color: '#f97316', completions: [] },
  { id: '5', name: 'Drekka vatn (2L)', icon: '💧', color: '#3b82f6', completions: [] },
]
