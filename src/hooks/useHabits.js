...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    { id: '1', name: 'Workout', icon: '🏋️', color: '#00d4aa', completions: [] },
    { id: '2', name: 'Golf (GOLF+)', icon: '⛳', color: '#10b981', completions: [] },
    { id: '3', name: 'Lesa / Audible', icon: '📚', color: '#8b5cf6', completions: [] },
    { id: '4', name: 'Drekka vatn', icon: '💧', color: '#3b82f6', completions: [] },
    { id: '5', name: 'Pomodoro × 4', icon: '🍅', color: '#f97316', completions: [] },
    { id: '6', name: 'Ganga út', icon: '🚶', color: '#22c55e', completions: [] },
  ])
