...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    { id: '1', name: 'Hlaup / hreyfingarækt', icon: '🏃', color: '#00d4aa', completions: [] },
    { id: '2', name: 'Hlusta á bók', icon: '🎧', color: '#8b5cf6', completions: [] },
    { id: '3', name: 'Drekka vatn', icon: '💧', color: '#3b82f6', completions: [] },
    { id: '4', name: 'Skoða leiktöflur', icon: '⚽', color: '#f97316', completions: [] },
    { id: '5', name: 'Golf+ æfing', icon: '🏌️', color: '#22c55e', completions: [] },
    { id: '6', name: 'Senda umsókn', icon: '💼', color: '#ec4899', completions: [] },
  ])
