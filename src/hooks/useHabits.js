...
const DEFAULTS = [
  { id: '1', name: 'Huel / næring', icon: '🥤', color: '#f97316', completions: [] },
  { id: '2', name: 'Hreyfingarækt',  icon: '🏋️', color: '#00d4aa', completions: [] },
  { id: '3', name: 'Kóðun',           icon: '💻', color: '#8b5cf6', completions: [] },
  { id: '4', name: 'Lesa',            icon: '📚', color: '#3b82f6', completions: [] },
  { id: '5', name: 'Garðurinn',       icon: '🌱', color: '#22c55e', completions: [] },
]

export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits_v2', DEFAULTS)
  ...
  const add = (name, icon = '⭐', color = '#00d4aa') => {
    setHabits(prev => [...prev, { id: Date.now().toString(), name, icon, color, completions: [] }])
  }
