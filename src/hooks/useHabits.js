...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits_v2', [
    { id: '1', name: 'Gym', icon: '🏋️', color: '#00d4aa', completions: [] },
    { id: '2', name: 'Huel', icon: '🥤', color: '#8b5cf6', completions: [] },
    { id: '3', name: 'Lesa', icon: '📚', color: '#3b82f6', completions: [] },
    { id: '4', name: 'Drekka vatn', icon: '💧', color: '#06b6d4', completions: [] },
    { id: '5', name: 'Ganga út', icon: '🚶', color: '#22c55e', completions: [] },
    { id: '6', name: 'Góður svefn', icon: '😴', color: '#f97316', completions: [] },
  ])
