...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    ...
    { id: '4', name: 'Pipar tékk', icon: '🌶️', color: '#ef4444', completions: [] },
    { id: '5', name: 'Lesa', icon: '📚', color: '#8b5cf6', completions: [] },
    { id: '6', name: 'Miðlunarreglur', icon: '🧘', color: '#84cc16', completions: [] },
  ])
