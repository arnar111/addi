...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    ...
    { id: '2', name: 'Huel máltíð', icon: '🥤', color: '#8b5cf6', completions: [] },
    { id: '3', name: 'Lesa', icon: '📚', color: '#3b82f6', completions: [] },
    { id: '4', name: 'Drekka vatn', icon: '💧', color: '#60a5fa', completions: [] },
    { id: '5', name: 'The Athletic', icon: '⚽', color: '#f97316', completions: [] },
