...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    { id: '1', name: 'Tradolan', icon: '💊', color: '#22c55e', completions: [] },
    { id: '2', name: 'Pipar vatning', icon: '🌶️', color: '#ef4444', completions: [] },
    { id: '3', name: 'Hreyfingarækt', icon: '🏋️', color: '#00d4aa', completions: [] },
    { id: '4', name: 'The Athletic', icon: '📰', color: '#f97316', completions: [] },
