...
export function useHabits() {
  const [habits, setHabits] = useLocalStorage('addi_habits', [
    { id: '1', name: 'Duolingo', icon: '🦜', color: '#22c55e', completions: [] },
    { id: '2', name: 'Hreyfingarækt', icon: '🏋️', color: '#00d4aa', completions: [] },
    { id: '3', name: 'Huel / Mataræði', icon: '🥤', color: '#8b5cf6', completions: [] },
    { id: '4', name: 'Hlusta / Lesa', icon: '🎧', color: '#f97316', completions: [] },
    { id: '5', name: 'Kóðun', icon: '💻', color: '#3b82f6', completions: [] },
  ])
