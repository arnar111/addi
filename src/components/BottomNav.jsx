...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Building2 } from 'lucide-react'
...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 safe-bottom md:hidden glass"
