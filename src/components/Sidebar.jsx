...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, Trophy, TrendingUp, Activity } from 'lucide-react'

const NAV = [
  { to: '/', icon: LayoutDashboard, label: 'Mælaborð' },
  { to: '/tasks', icon: CheckSquare, label: 'Verkefni' },
  { to: '/finance', icon: Wallet, label: 'Fjármál' },
  { to: '/habits', icon: Activity, label: 'Vanur' },
  { to: '/notes', icon: FileText, label: 'Minnisblöð' },
  { to: '/sports', icon: Trophy, label: 'Íþróttir' },
  { to: '/lendo', icon: TrendingUp, label: 'Lendó' },
