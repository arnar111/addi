...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, Dumbbell, Tag } from 'lucide-react'

const NAV = [
  { to: '/', icon: LayoutDashboard, label: 'Mælaborð' },
  { to: '/sports', icon: Dumbbell, label: 'Íþróttir' },
  { to: '/lendo', icon: Tag, label: 'Lendó' },
