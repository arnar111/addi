...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, Target } from 'lucide-react'
    ...
    >
      <div className="flex items-center gap-2 px-3 mb-8">
        ...
        <span className="text-xs ml-auto px-1.5 py-0.5 rounded-md"
              style={{ background: 'rgba(0,212,170,0.12)', color: 'var(--accent)', fontSize: 10 }}>v1.1</span>
      </div>
