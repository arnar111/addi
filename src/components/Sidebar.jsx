...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, ShoppingCart, Activity } from 'lucide-react'

const NAV = [
  { to: '/', icon: LayoutDashboard, label: 'Mælaborð' },
  { to: '/tasks', icon: CheckSquare, label: 'Verkefni' },
  { to: '/finance', icon: Wallet, label: 'Fjármál' },
  { to: '/shopping', icon: ShoppingCart, label: 'Verslunarlistinn' },
  { to: '/habits', icon: Activity, label: 'Vanir' },
