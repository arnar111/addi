...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, Building2 } from 'lucide-react'

const NAV = [
  { to: '/', icon: LayoutDashboard, label: 'Mælaborð' },
  { to: '/tasks', icon: CheckSquare, label: 'Verkefni' },
  { to: '/lendo', icon: Building2, label: 'Lendó 🪑' },
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 shrink-0 h-screen sticky top-0 py-6 px-3"
      ...
      <div className="flex items-center gap-2 px-3 mb-8">
        ...
        <span className="text-xs ml-auto px-1.5 py-0.5 rounded-md font-semibold"
          style={{ background: 'rgba(0,212,170,0.15)', color: 'var(--accent)' }}>v2</span>
      </div>
