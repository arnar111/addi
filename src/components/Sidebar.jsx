...
import { LayoutDashboard, CheckSquare, Wallet, FileText, Timer, Settings, Shirt } from 'lucide-react'
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 shrink-0 h-screen sticky top-0 py-6 px-3"
      ...
      <div className="flex items-center gap-2.5 px-3 mb-8">
        ...
        <div>
          <div className="font-bold text-lg leading-none">Addi</div>
          <div className="text-xs leading-none mt-0.5" style={{ color: 'var(--muted)' }}>v1.0</div>
        </div>
      </div>
      ...
      <div className="px-3 pb-1">
        <div className="text-xs" style={{ color: 'var(--muted)' }}>Arnar Kjartansson</div>
        <div className="text-xs mt-0.5" style={{ color: 'var(--muted)' }}>📍 Reykjavík</div>
      </div>
    </aside>
  )
}
